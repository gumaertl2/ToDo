...
export const UsersView: React.FC = () => {
  const { user, users, helpers, groups, events, tasks, fetchUsersAndHelpers, fetchTemplatesAndRoutines, fetchEvents, fetchTasks, saveAgendaItem, cleanupExpiredHelpers, deleteHelper, deleteUser, deleteGroup, isUsersLoading } = useClubStore();
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 flex-1 overflow-hidden flex flex-col">
          {isUsersLoading ? (
            ...
            <div className="divide-y divide-gray-200 flex-1 overflow-y-auto">
              ...
              {/* CHIRURGISCHER EINGRIFF: Vorstände A-Z sortiert */}
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        {/* Rollen-Badges des Users ebenfalls sortiert anzeigen */}
                        {[...(u.groupIds || [])].sort((a, b) => (groups.find(g => g.id === a)?.name || '').localeCompare(groups.find(g => g.id === b)?.name || '')).map(gid => {
              ...
              {/* CHIRURGISCHER EINGRIFF: Helfer A-Z sortiert */}
              {activeTab === 'helfer' && [...helpers].sort((a, b) => a.name.localeCompare(b.name)).map((h) => (
              ...
              {/* CHIRURGISCHER EINGRIFF: Rollen A-Z sortiert */}
