    ...
    <div className="h-full flex flex-col space-y-6">
      ...
      {pendingRemindersCount > 0 && (
        <div 
          ...
          className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-center justify-between cursor-pointer hover:bg-green-100 transition-colors shadow-sm animate-fade-in"
        >
          <div className="flex items-center">
            <div className="bg-green-600 text-white p-2 rounded-full mr-4 shadow-sm">
              <MessageCircle className="w-5 h-5" />
            </div>
            <div>
              <h3 className="font-bold text-green-900">WhatsApp Erinnerungen fällig</h3>
              <p className="text-sm text-green-800">Du hast <span className="font-bold">{pendingRemindersCount}</span> ausstehende {pendingRemindersCount === 1 ? 'Erinnerung' : 'Erinnerungen'} zum Versenden.</p>
            </div>
          </div>
